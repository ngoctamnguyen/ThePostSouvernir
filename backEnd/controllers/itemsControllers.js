...
module.exports.getGroupItem = async (req, res, next) => {
     try {
          ...
          let str = "SELECT Mathang.Mahang AS Mahang, Mathang.Tenhang AS Tenhang, Mathang.TenhangUnicode AS TenhangUnicode, Mathang.Manhom AS Manhom, Mathang.tonkho AS tonkho, Mathang.tonban AS tonban, Mathang.Tonhientai AS Tonhientai, Mathang.Giaban AS Giaban, kiemhang.chenhLech AS chenhlech, FORMAT(kiemhang.Ngay, 'MM/dd/yyyy HH:mm:ss') AS ngaykiem ";
          ...
          str += "GROUP BY Mathang.Mahang, Mathang.Tenhang, Mathang.TenhangUnicode, Mathang.Manhom, Mathang.tonkho, Mathang.tonban, Mathang.Tonhientai, Mathang.Giaban, kiemhang.chenhLech, kiemhang.Ngay ";
